...
//      public ChoiceAction getDescAction()               { return getDialogAction(desc); }
   ...
   public static final class BooleanPref extends Pref<Boolean> {
      ...
      public BooleanPref(String id, String title, String desc)          { this(id, title, desc, false); }
      public BooleanPref(String id, String title, boolean defaultValue) { super(id, title); this.defaultValue = defaultValue; }
      public BooleanPref(String id, String title)                       { this(id, title, false); }
...
//   };
   ...
   public static final ChoicePref<Verbosity> VerbosityPref = new ChoicePref<Verbosity>("Verbosity", Verbosity.values(),
         Verbosity.DEFAULT) {
