...
pred semanticsLetAxpb1[eval: Node->Int, n: LetAxpb1] { eval[n] = plus[mul[n.yVal, eval[X1]], n.zVal] }
pred semanticsLetAxpb2[eval: Node->Int, n: LetAxpb2] { eval[n] = plus[mul[n.yVal, eval[X2]], n.zVal] }
